...
public class GenerateTradeTest extends BaseTest {
    @Autowired
    ...
    public void beforeClass() {
        ...
        try {
             endDate = dateFormat.parse("2012-02-02");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        request.setAttribute("endDay", endDate);
        request.setAttribute("totalDay", 2);
    ...
    @Test
    public void testGenerateNTrade_history() throws Exception {
        ...
        for (int i = 0; i < total/batchSize; i++) {
            ...
            tradeJdbcDao.addHistory(trades);
            stopWatch.stop();
            System.out.println("iteration "+i+" generated " + batchSize + " Trade_history in " + stopWatch.getLastTaskTimeMillis() + " ms.");
        }
